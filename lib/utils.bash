...
# NOTE: You might want to remove this if cook is not hosted on GitHub releases.
...
download_release() {
	...
	# TODO: Adapt the release URL convention for cook
...
install_version() {
	...
	(
		...
		# TODO: Assert cook executable exists.
		local tool_cmd
